    ...
    <div className="min-h-screen bg-gray-100 pb-10">
      ...
      {helpOpen && (
        <HelpModal onClose={() => setHelpOpen(false)} sections={[
          ...
          { title: 'טיימר מנוחה', body: 'לחץ על הטיימר בפס הכחול/אפור להפעלה. כוונן זמן עם + / −. הטיימר מופיע גם בתוך מסך רישום התרגיל, כדי להפעילו בין סט לסט — זהו אותו טיימר, ושינוי במקום אחד משתקף בשני.' },
