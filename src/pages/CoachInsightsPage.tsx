    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
        ...
        {!cached && !loading && !error && (
          <div className="bg-white rounded-2xl p-6 shadow-sm text-center">
            ...
            <p className="text-gray-500 text-xs leading-relaxed">
              ניתוח של 4 השבועות האחרונים — מה עבד, ומה כדאי לשנות בפעם הבאה.
              מבוסס על האימונים, ה-RIR וההערות שרשמת.
            </p>
          </div>
        )}
      ...
      {helpOpen && (
        <HelpModal onClose={() => setHelpOpen(false)} sections={[
          { title: 'מה זה', body: 'מאמן AI שקורא את האימונים שלך מ-4 השבועות האחרונים — סטים, חזרות, משקלים, RIR והערות — ונותן מבט לאחור ומבט קדימה.' },
